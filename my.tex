...
\begin{table}[htbp]
\centering
\caption{Qualitative translation examples generated by the final Poly-Dialectal BanglaT5 model across diverse regional dialect pairs, comparing generated output against reference ground truth.}
\label{tab:qualitative}
\small
\begin{tabular}{@{}l p{3.8cm} p{3.8cm} p{3.8cm}@{}}
\toprule
\textbf{Direction} & \textbf{Source Text (Romanized)} & \textbf{Generated Output (Romanized)} & \textbf{Reference GT (Romanized)} \\
\midrule
