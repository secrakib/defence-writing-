...
\begin{enumerate}
    \item \textbf{Largest Multi-Dialectal Parallel Corpus:} We construct the most expansive multi-dialect machine translation corpus for Bangla to date, comprising 14,552 aligned rows across 12 regional dialect columns. The corpus integrates seven prior datasets---Ancholik-NER, Anubhuti, BanglaDial, BhasaBodh, ChatgaiyyaAlap, ONUBAD, and Vashantor---yielding a grand total of 51,531 non-null parallel sentence pairs spanning Standard Bangla and 11 regional variants including four previously uncovered dialects (Kishoreganj, Narail, Narsingdi, and Tangail).
    \item \textbf{Comprehensive Evaluation of Multilingual NMT Architectures:} We systematically fine-tune and empirically evaluate three prominent Sequence-to-Sequence models---BanglaT5 \cite{bhattacharjee-etal-2023-banglanlg}, NLLB-200 \cite{nllb2022}, and mBART-50 \cite{tang2020multilingual}---under diverse, multi-directional translation settings using parameter-efficient Low-Rank Adaptation (LoRA) \cite{hu2021lora}.
    \item \textbf{Systematic Cross-Dialectal Linguistic Analysis:} We conduct a rigorous quantitative characterization of cross-dialectal transfer mechanisms. By analyzing performance metrics (BLEU \cite{papineni2002bleu}, chrF++ \cite{popovic2015chrf}, TER \cite{snover2006study}, METEOR \cite{banerjee2005meteor}) against linguistic divergences, we uncover how morphological proximity and training data volume jointly influence neural machine translation efficacy.
\end{enumerate}
